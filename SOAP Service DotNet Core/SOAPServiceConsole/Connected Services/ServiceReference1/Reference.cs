...
namespace ServiceReference1
{
    ...
    public partial class Execute
    {
        ...
        public string jsonParmString;
        
        public Execute()
        {
        }
        
        public Execute(string actionName, string jsonParmString)
        {
            this.actionName = actionName;
            this.jsonParmString = jsonParmString;
        }
    }
    ...
    public partial class ExecuteCodeUnit_PortClient : System.ServiceModel.ClientBase<ServiceReference1.ExecuteCodeUnit_Port>, ServiceReference1.ExecuteCodeUnit_Port
    {
        ...
        public System.Threading.Tasks.Task<ServiceReference1.Execute_Result> ExecuteAsync(string actionName, string jsonParmString)
        {
            ServiceReference1.Execute inValue = new ServiceReference1.Execute();
            inValue.actionName = actionName;
            inValue.jsonParmString = jsonParmString;
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.ExecuteCodeUnit_Port))
            {
                return new System.ServiceModel.EndpointAddress("http://win-jhhr4oovksp:7047/POWERDIVERPSERVICE/WS/APSCL/Codeunit/ExecuteCodeUnit");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
