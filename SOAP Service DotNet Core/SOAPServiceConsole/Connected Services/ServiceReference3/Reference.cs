...
namespace ServiceReference3
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:microsoft-dynamics-schemas/codeunit/ExecuteCodeUnit", ConfigurationName="ServiceReference3.ExecuteCodeUnit_Port")]
    public interface ExecuteCodeUnit_Port
    {
        ...
        System.Threading.Tasks.Task<ServiceReference3.Execute_Result> ExecuteAsync(ServiceReference3.Execute request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface ExecuteCodeUnit_PortChannel : ServiceReference3.ExecuteCodeUnit_Port, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class ExecuteCodeUnit_PortClient : System.ServiceModel.ClientBase<ServiceReference3.ExecuteCodeUnit_Port>, ServiceReference3.ExecuteCodeUnit_Port
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference3.Execute_Result> ServiceReference3.ExecuteCodeUnit_Port.ExecuteAsync(ServiceReference3.Execute request)
        {
            return base.Channel.ExecuteAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference3.Execute_Result> ExecuteAsync(string actionName, string actionParameters)
        {
            ServiceReference3.Execute inValue = new ServiceReference3.Execute();
            inValue.actionName = actionName;
            inValue.actionParameters = actionParameters;
            return ((ServiceReference3.ExecuteCodeUnit_Port)(this)).ExecuteAsync(inValue);
        }
